...
export default function AddTransactionForm({ setIsAddOpen, onAddTransaction, onEditTransaction, transaction, translation }) {
	...
	return (
		<div className="modal">
			<div className="modal-header">
				...
				<div className="close-btn" onClick={() => setIsAddOpen(false)}>
					&times;
				</div>
			</div>
			<div className="modal-body">
				<form onSubmit={handleSubmit}>
					...
					<input
						...
						required
					/>
					<input type="date" value={formattedDate} onChange={(e) => setDate(new Date(e.target.value))} required />
